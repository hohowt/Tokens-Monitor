...
export const mockUserRanking: RankingItem[] = [
  { id: 1, name: "张三", total_tokens: 890_000_000, cost_cny: 18500, requests: 12300 },
  { id: 2, name: "李四", total_tokens: 720_000_000, cost_cny: 15200, requests: 9800 },
  { id: 3, name: "王五", total_tokens: 650_000_000, cost_cny: 13800, requests: 8500 },
  { id: 4, name: "赵六", total_tokens: 580_000_000, cost_cny: 11200, requests: 7200 },
  { id: 5, name: "钱七", total_tokens: 510_000_000, cost_cny: 10500, requests: 6800 },
  { id: 6, name: "孙八", total_tokens: 430_000_000, cost_cny: 9200, requests: 5900 },
  { id: 7, name: "周九", total_tokens: 380_000_000, cost_cny: 7800, requests: 5100 },
  { id: 8, name: "吴十", total_tokens: 320_000_000, cost_cny: 6500, requests: 4300 },
  { id: 9, name: "郑十一", total_tokens: 280_000_000, cost_cny: 5800, requests: 3800 },
  { id: 10, name: "冯十二", total_tokens: 230_000_000, cost_cny: 4900, requests: 3200 },
];
